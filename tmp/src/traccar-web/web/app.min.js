...
!1)?Ext.Date.format(a,Traccar.Style.dateTimeFormat12):Ext.Date.format(a,Traccar.Style.dateTimeFormat24):a},getFormatter:function(a){var b=this;switch(a){case "latitude":case "longitude":return function(c){return b.coordinateFormatter(a,c)};case "speed":return this.speedFormatter;case "course":return this.courseFormatter;case "distance":case "accuracy":return this.distanceFormatter;case "duration":return this.durationFormatter;case "deviceId":return this.deviceIdFormatter;case "groupId":return this.groupIdFormatter;
case "geofenceId":return this.geofenceIdFormatter;case "maintenanceId":return this.maintenanceIdFormatter;case "calendarId":return this.calendarIdFormatter;case "lastUpdate":return this.lastUpdateFormatter;case "spentFuel":return this.volumeFormatter;case "driverUniqueId":return this.driverUniqueIdFormatter;case "commandType":return this.commandTypeFormatter;default:return this.defaultFormatter}},getConverter:function(a){switch(a){case "speed":return this.speedConverter;case "distance":case "accuracy":return this.distanceConverter;
case "spentFuel":return this.volumeConverter;default:return function(a){return a}}},getAttributeFormatter:function(a){switch(Ext.getStore("PositionAttributes").getAttributeDataType(a)){case "distance":return this.distanceFormatter;case "speed":return this.speedFormatter;case "driverUniqueId":return this.driverUniqueIdFormatter;case "voltage":return this.numberFormatterFactory(Traccar.Style.numberPrecision,Strings.sharedVoltAbbreviation);case "percentage":return this.numberFormatterFactory(Traccar.Style.numberPrecision,
"\x26#37;");case "temperature":return this.numberFormatterFactory(Traccar.Style.numberPrecision,"\x26deg;C");case "volume":return this.volumeFormatter;case "hours":return this.hoursFormatter;case "consumption":return this.numberFormatterFactory(Traccar.Style.numberPrecision,Strings.sharedLiterPerHourAbbreviation);default:return this.defaultFormatter}},getAttributeConverter:function(a){switch(Ext.getStore("PositionAttributes").getAttributeDataType(a)){case "distance":return this.distanceConverter;
...
dataIndex:"always",renderer:Traccar.AttributeFormatter.getFormatter("always"),filter:"boolean"},{text:Strings.notificationNotificators,dataIndex:"notificators",flex:2,filter:{type:"arraylist",idField:"type",labelField:"name",store:"AllNotificators"},renderer:function(a){var b="",c;if(a)for(c=a.split(/[ ,]+/).filter(Boolean),a=0;a<c.length;a++)b+=Traccar.app.getNotificatorString(c[a])+(a<c.length-1?", ":"");return b}},{text:Strings.sharedCalendar,dataIndex:"calendarId",hidden:!0,filter:{type:"list",
labelField:"name",store:"AllCalendars"},renderer:Traccar.AttributeFormatter.getFormatter("calendarId")}]}});Ext.define("Traccar.view.StatisticsController",{extend:Ext.app.ViewController,alias:"controller.statistics",onShowClick:function(){Ext.getStore("Statistics").load({params:{from:this.lookupReference("fromDateField").getValue().toISOString(),to:this.lookupReference("toDateField").getValue().toISOString()}})}});
...
Ext.getStore("Calendars").load();Ext.getStore("Maintenances").load();Ext.getStore("ComputedAttributes").load();Ext.getStore("AllCommandTypes").load();Ext.getStore("Commands").load();Ext.getStore("AllNotificationTypes").load({callback:function(a,c,d){c=Ext.getStore("ReportEventTypes");d&&(c.add({type:Traccar.store.ReportEventTypes.allEvents,name:Strings.eventAll}),c.loadData(a,!0))}});Ext.getStore("AllNotificators").load();Ext.getStore("Notifications").load();Ext.getStore("ServerAttributes").loadData(Ext.getStore("CommonDeviceAttributes").getData().items,
...
a[c]));b&&((a=Ext.Object.fromQueryString(window.location.search).deviceId)&&(f=Ext.getStore("VisibleDevices").findRecord("id",a,0,!1,!0,!0))&&this.fireEvent("selectdevice",f,!0),f||this.zoomToAllDevices())},updateEvents:function(a){var b,c,d;c=Ext.getStore("Events");for(b=0;b<a.length;b++)c.add(a[b]),(d=Ext.getStore("Devices").getById(a[b].deviceId))?(this.soundPressed()&&this.beep(),Traccar.app.showToast(a[b].text,d.get("name"))):Traccar.app.showToast(a[b].text)},zoomToAllDevices:function(){var a,
b,c;a=Traccar.app.getPreference("latitude",0);b=Traccar.app.getPreference("longitude",0);c=Traccar.app.getPreference("zoom",0);0===a&&0===b&&0===c&&this.fireEvent("zoomtoalldevices")}});
...
isMobile:function(){return window.matchMedia&&window.matchMedia("(max-width: 768px)").matches},getVehicleFeaturesDisabled:function(){return this.getBooleanAttributePreference("ui.disableVehicleFetures")},getEventString:function(a){a="event"+a.charAt(0).toUpperCase()+a.slice(1);return Strings[a]||a},getNotificatorString:function(a){a="notificator"+a.charAt(0).toUpperCase()+a.slice(1);return Strings[a]||a},showReports:function(a){var b=Ext.getCmp("rootPanel");b&&b.setActiveItem(a?1:0)},showEvents:function(a){var b=
Ext.getCmp("rootPanel");b&&b.setActiveItem(a?2:0)},setUser:function(a){this.user=Ext.create("Ext.data.reader.Json",{model:"Traccar.model.User"}).readRecords(a).getRecords()[0]},getUser:function(){return this.user},setServer:function(a){this.server=Ext.create("Ext.data.reader.Json",{model:"Traccar.model.Server"}).readRecords(a).getRecords()[0]},getServer:function(){return this.server},getPreference:function(a,b){return this.getServer().get("forceSettings")?this.getServer().get(a)||this.getUser().get(a)||
...
if(b)return b;b=0;void 0!==a&&(b=a%Traccar.Style.mapRouteColor.length);return Traccar.Style.mapRouteColor[b]},showError:function(a){Ext.isString(a)?Ext.Msg.alert(Strings.errorTitle,a):a.responseText?Ext.Msg.alert(Strings.errorTitle,Strings.errorGeneral+'\x3cbr\x3e\x3cbr\x3e\x3ctextarea readonly rows\x3d"5" style\x3d"resize: none; width: 100%;"\x3e'+a.responseText+"\x3c/textarea\x3e"):a.statusText?Ext.Msg.alert(Strings.errorTitle,a.statusText):Ext.Msg.alert(Strings.errorTitle,Strings.errorConnection)},
showToast:function(a,b){Ext.toast({html:a,title:b,width:Traccar.Style.toastWidth,align:"br"})}});Ext.application({name:"Traccar",extend:Traccar.Application});